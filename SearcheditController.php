    ...
    public function getsearchresult(Request $request){
        ...
        if(!empty($data))
        {
            foreach($data as $row){
                ...
                <td id="tdedit" style="vertical-align: text-top; width: 4em; font-size: .9em;"><a target="_blank" href='. url('publicationupdate/'.base64_encode($row->hdrid)) .'><img id="imgsearchedit" src="../image/edit-icon.png"></a></td>
                <td id="tddelete" style="vertical-align: text-top; width: 4em; font-size: .9em;"><img id="imgsearchdelete" src="../image/delete-icon.png"></td>
