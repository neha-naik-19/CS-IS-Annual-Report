...
$(document).ready(function () {
    ...
    function search_data() {
        ...
        $.ajax({
            ...
            data: {
                ...
                ranking: rankingdata.length > 0 ? rankingdata : null,
                author: authordata.length > 0 ? authordata : null,
            },
            success: function (data) {
    ...
    $("#btnsearchedit").click(function (e) {
        ...
        if (
            $("#searchdatefldfrom").val() == "" &&
            $("#searchdatefldto").val() == "" &&
            $("#authortypeselect").val() == "0" &&
            $("#categoryselect").val() == "0" &&
            $("#nationalityselect").val() == "0" &&
            $("#titlesearch").val() == "" &&
        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data, function (key, value) {
                    $(".multicheck").append(
                        '<label><input type="checkbox" class="rankingchk" name="rankingoption[]" value="' +
                            value.id +
                            '" />' +
                            " " +
                            value.ranking +
                    ...
                    $(".multicheckprint").append(
                        '<label><input type="checkbox" class="rankingprintchk" name="rankingprintoption[]" value="' +
                            value.id +
                            '" />' +
                            " " +
                            value.ranking +
